...
class MapDraw:
    ...
    fillColors = {0: "White", 1: "LightBlue", 2: "LightGreen", 3: "DarkRed"}
    ...
    def __init__(self, screenWidth, screenHeight, cellX, cellY):
        ...
        self.rectangles = [ [ self.canvas.create_rectangle(self.cell_width*x, self.cell_height*y, self.cell_height*x+self.cell_width, self.cell_width*y+self.cell_height, fill="#000000", width=1)
                                 for x in range(cellY)]
                                             for y in range(cellX)]
    ...
    def drawTile(self, tileType, x, y):
        ...
        self.canvas.itemconfig(self.rectangles[x][y], fill=borderColor)
